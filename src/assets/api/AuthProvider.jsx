...
//   // luôn chạy 1 lần khi refresh trang: lấy token cũ từ localStorage => giữ trạng thái đăng nhập
//   useEffect(() => {
...
//   // chạy khi token thay đổi: login - logout 
//   useEffect(() => {
//     if (token) {
...
//       const data = await response.text(); // token dạng chuỗi
//       setToken(data);
//       setStatus('succeeded');
//     } catch (err) {
